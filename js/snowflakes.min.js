...
!(function (t, e) {
  "object" == typeof exports && "undefined" != typeof module
    ...
    ? define(e)
    : ((t =
        "undefined" != typeof globalThis ? globalThis : t || self).Snowflakes =
        e());
})(this, function () {
  "use strict";
  var t = "";
  function e(e, a) {
    Object.keys(a).forEach(function (n) {
      var i = n;
      t &&
        n.search("animation") > -1 &&
        (i = t + n[0].toUpperCase() + n.substr(1)),
        (e.style[i] = a[n]);
    });
  }
  function a(t) {
  ...
  var r = (function () {
    function t(t) {
      ...
      a ||
        (m.opacity = String(
          o(this.size, t.minSize, t.maxSize, t.minOpacity, t.maxOpacity)
        )),
        e(i, m),
        e(r, {
      ...
      (t.prototype.getAnimationProps = function (t) {
        ...
        return {
          ...
          animationDuration: String(
            o(this.size, t.minSize, t.maxSize, e, a) + "s"
          ),
        };
      }),
      t
  ...
  return (function () {
    ...
    return (
      ...
      (t.prototype.appendStyles = function () {
        t.instanceCounter ||
          (this.mainStyleNode = this.injectStyle(
            '.snowflake{-webkit-animation:snowflake_unknown 10s linear infinite;animation:snowflake_unknown 10s linear infinite;pointer-events:none;position:absolute;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none;will-change:transform}.snowflake__inner,.snowflake__inner:before{bottom:0;left:0;position:absolute;right:0;top:0}.snowflake__inner:before{background-size:100% 100%;content:""}.snowflake__inner_wind{-webkit-animation:snowflake_unknown 2s ease-in-out infinite alternate;animation:snowflake_unknown 2s ease-in-out infinite alternate}.snowflake__inner_rotation:before{-webkit-animation:snowflake_rotation 10s linear infinite;animation:snowflake_rotation 10s linear infinite}.snowflake__inner_rotation_reverse:before{-webkit-animation:snowflake_rotation_reverse 10s linear infinite;animation:snowflake_rotation_reverse 10s linear infinite}@-webkit-keyframes snowflake_rotation{0%{-webkit-transform:rotate(0deg);transform:rotate(0deg)}to{-webkit-transform:rotate(1turn);transform:rotate(1turn)}}@keyframes snowflake_rotation{0%{-webkit-transform:rotate(0deg);transform:rotate(0deg)}to{-webkit-transform:rotate(1turn);transform:rotate(1turn)}}@-webkit-keyframes snowflake_rotation_reverse{0%{-webkit-transform:rotate(0deg);transform:rotate(0deg)}to{-webkit-transform:rotate(-1turn);transform:rotate(-1turn)}}@keyframes snowflake_rotation_reverse{0%{-webkit-transform:rotate(0deg);transform:rotate(0deg)}to{-webkit-transform:rotate(-1turn);transform:rotate(-1turn)}}.snowflakes{pointer-events:none}.snowflakes_paused .snowflake,.snowflakes_paused .snowflake__inner,.snowflakes_paused .snowflake__inner:before{-webkit-animation-play-state:paused;animation-play-state:paused}.snowflakes_hidden{visibility:hidden}.snowflakes_body{height:1px;left:0;position:fixed;top:0;width:100%}'
          )),
          t.instanceCounter++,
      ...
      (t.prototype.getAnimationStyle = function () {
        for (
          var t = this.height() + this.params.maxSize * Math.sqrt(2) + "px",
            e = this.gid,
            a =
      ...
      (t.prototype.removeStyles = function () {
        t.instanceCounter || (a(this.mainStyleNode), delete this.mainStyleNode),
